...
00000000000011c0 <main>:
    ...
    125f:	48 8d 3d fa 2e 00 00 	lea    0x2efa(%rip),%rdi        # 4160 <heat>
    1266:	48 8d 35 93 30 00 00 	lea    0x3093(%rip),%rsi        # 4300 <heat2>
    ...
    12a3:	48 8d 3d 2e 0e 00 00 	lea    0xe2e(%rip),%rdi        # 20d8 <_IO_stdin_used+0xd8>
    12aa:	48 8d 35 34 0e 00 00 	lea    0xe34(%rip),%rsi        # 20e5 <_IO_stdin_used+0xe5>
    12b1:	ba 34 00 00 00       	mov    $0x34,%edx
    12b6:	48 8d 0d 32 0e 00 00 	lea    0xe32(%rip),%rcx        # 20ef <_IO_stdin_used+0xef>
    ...
    12d6:	48 8d 3d 21 0e 00 00 	lea    0xe21(%rip),%rdi        # 20fe <_IO_stdin_used+0xfe>
    12dd:	b0 01                	mov    $0x1,%al
    12df:	e8 5c fd ff ff       	call   1040 <printf@plt>
    12e4:	f2 0f 10 05 7c 0d 00 	movsd  0xd7c(%rip),%xmm0        # 2068 <_IO_stdin_used+0x68>
    12eb:	00 
    12ec:	f2 0f 5e 45 d8       	divsd  -0x28(%rbp),%xmm0
    12f1:	48 8d 3d 15 0e 00 00 	lea    0xe15(%rip),%rdi        # 210d <_IO_stdin_used+0x10d>
    12f8:	b0 01                	mov    $0x1,%al
    12fa:	e8 41 fd ff ff       	call   1040 <printf@plt>
    12ff:	48 8d 3d 23 0e 00 00 	lea    0xe23(%rip),%rdi        # 2129 <_IO_stdin_used+0x129>
    1306:	b0 00                	mov    $0x0,%al
    1308:	e8 33 fd ff ff       	call   1040 <printf@plt>
    130d:	48 8d 3d 24 0e 00 00 	lea    0xe24(%rip),%rdi        # 2138 <_IO_stdin_used+0x138>
    1314:	b0 00                	mov    $0x0,%al
    1316:	e8 25 fd ff ff       	call   1040 <printf@plt>
    131b:	f3 0f 10 05 e1 0c 00 	movss  0xce1(%rip),%xmm0        # 2004 <_IO_stdin_used+0x4>
    1322:	00 
    1323:	f3 0f 10 0d dd 0c 00 	movss  0xcdd(%rip),%xmm1        # 2008 <_IO_stdin_used+0x8>
    132a:	00 
    132b:	e8 70 fd ff ff       	call   10a0 <powf@plt>
    1330:	f3 0f 5a c8          	cvtss2sd %xmm0,%xmm1
    1334:	f2 0f 10 05 24 0d 00 	movsd  0xd24(%rip),%xmm0        # 2060 <_IO_stdin_used+0x60>
    133b:	00 
    133c:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    1340:	f2 0f 10 0d 10 0d 00 	movsd  0xd10(%rip),%xmm1        # 2058 <_IO_stdin_used+0x58>
    1347:	00 
    1348:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    134c:	f2 0f 10 0d fc 0c 00 	movsd  0xcfc(%rip),%xmm1        # 2050 <_IO_stdin_used+0x50>
    1353:	00 
    ...
    137e:	f3 0f 10 0d 7e 0c 00 	movss  0xc7e(%rip),%xmm1        # 2004 <_IO_stdin_used+0x4>
    1385:	00 
    1386:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    138a:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    138e:	f2 0f 11 45 c8       	movsd  %xmm0,-0x38(%rbp)
    1393:	48 8d 05 c6 2d 00 00 	lea    0x2dc6(%rip),%rax        # 4160 <heat>
    ...
    13bb:	f2 0f 10 1d ad 0c 00 	movsd  0xcad(%rip),%xmm3        # 2070 <_IO_stdin_used+0x70>
    13c2:	00 
    13c3:	f2 0f 58 d3          	addsd  %xmm3,%xmm2
    13c7:	f2 0f 5e c2          	divsd  %xmm2,%xmm0
    13cb:	f2 0f 11 45 c0       	movsd  %xmm0,-0x40(%rbp)
    13d0:	48 8d 05 29 2f 00 00 	lea    0x2f29(%rip),%rax        # 4300 <heat2>
    13d7:	f3 0f 10 04 88       	movss  (%rax,%rcx,4),%xmm0
    13dc:	f3 0f 59 c9          	mulss  %xmm1,%xmm1
    13e0:	f3 0f 10 15 2c 0c 00 	movss  0xc2c(%rip),%xmm2        # 2014 <_IO_stdin_used+0x14>
    13e7:	00 
    ...
    1422:	f3 0f 10 25 e6 0b 00 	movss  0xbe6(%rip),%xmm4        # 2010 <_IO_stdin_used+0x10>
    1429:	00 
    142a:	f3 0f 58 dc          	addss  %xmm4,%xmm3
    142e:	f3 0f 5a db          	cvtss2sd %xmm3,%xmm3
    1432:	f2 0f 5e d3          	divsd  %xmm3,%xmm2
    1436:	48 8d 3d 17 0d 00 00 	lea    0xd17(%rip),%rdi        # 2154 <_IO_stdin_used+0x154>
    ...
    1452:	f3 0f 10 05 96 2e 00 	movss  0x2e96(%rip),%xmm0        # 42f0 <heat+0x190>
    1459:	00 
    145a:	f3 0f 10 0d aa 0b 00 	movss  0xbaa(%rip),%xmm1        # 200c <_IO_stdin_used+0xc>
    1461:	00 
    1462:	f3 0f 5e c1          	divss  %xmm1,%xmm0
    1466:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    146a:	48 8d 3d f8 0c 00 00 	lea    0xcf8(%rip),%rdi        # 2169 <_IO_stdin_used+0x169>
...
0000000000001520 <photon>:
    ...
    1658:	f3 0f 10 15 cc 09 00 	movss  0x9cc(%rip),%xmm2        # 202c <_IO_stdin_used+0x2c>
    165f:	00 
    1660:	f3 0f 59 c2          	mulss  %xmm2,%xmm0
    1664:	f3 0f 58 c1          	addss  %xmm1,%xmm0
    1668:	f3 0f 11 04 88       	movss  %xmm0,(%rax,%rcx,4)
    166d:	f3 0f 10 05 b3 09 00 	movss  0x9b3(%rip),%xmm0        # 2028 <_IO_stdin_used+0x28>
    1674:	00 
    ...
    1698:	f3 0f 10 05 84 09 00 	movss  0x984(%rip),%xmm0        # 2024 <_IO_stdin_used+0x24>
    169f:	00 
    ...
    16b3:	f3 0f 10 0d 75 09 00 	movss  0x975(%rip),%xmm1        # 2030 <_IO_stdin_used+0x30>
    16ba:	00 
    ...
    16cd:	f3 0f 10 0d 5b 09 00 	movss  0x95b(%rip),%xmm1        # 2030 <_IO_stdin_used+0x30>
    16d4:	00 
    ...
    1704:	f3 0f 10 0d 10 09 00 	movss  0x910(%rip),%xmm1        # 201c <_IO_stdin_used+0x1c>
    170b:	00 
    ...
    171e:	f3 0f 10 0d 0a 09 00 	movss  0x90a(%rip),%xmm1        # 2030 <_IO_stdin_used+0x30>
    1725:	00 
    ...
    1754:	f3 0f 10 0d c0 08 00 	movss  0x8c0(%rip),%xmm1        # 201c <_IO_stdin_used+0x1c>
    175b:	00 
    ...
    17a0:	f3 0f 10 0d 74 08 00 	movss  0x874(%rip),%xmm1        # 201c <_IO_stdin_used+0x1c>
    17a7:	00 
    ...
    17c7:	f3 0f 10 05 65 08 00 	movss  0x865(%rip),%xmm0        # 2034 <_IO_stdin_used+0x34>
    17ce:	00 
    ...
    17de:	f3 0f 10 0d 52 08 00 	movss  0x852(%rip),%xmm1        # 2038 <_IO_stdin_used+0x38>
    17e5:	00 
    ...
    17f9:	f3 0f 10 0d 37 08 00 	movss  0x837(%rip),%xmm1        # 2038 <_IO_stdin_used+0x38>
    1800:	00 
